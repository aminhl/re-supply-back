...
router.route("/").post(authController.protect, authController.restrictTo("admin","member") ,exchangeController.createExchangeRequest).get(authController.protect,authController.restrictTo("admin","member"),exchangeController.getAllExchangeRequests);
